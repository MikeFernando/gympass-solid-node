...
`);
    ...
    function $r({ error: e, user_facing_error: r }, t, n) {
      return r.error_code ? new z3(um(r, n), { code: r.error_code, clientVersion: t, meta: r.meta, batchRequestIdx: r.batch_request_idx }) : new V(e, { clientVersion: t, batchRequestIdx: r.batch_request_idx });
    }
    function um(e, r) {
      let t = e.message;
...
var require_prisma = __commonJS({
  "src/generated/prisma/index.js"(exports2) {
    ...
    exports2.Prisma.GymScalarFieldEnum = {
      id: "id",
      title: "title",
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "C:\\Users\\dev\\www\\gympass\\src\\generated\\prisma",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "C:\\Users\\dev\\www\\gympass\\prisma\\schema.prisma",
        "isCustomOutput": true
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
      ...
      "inlineSchemaHash": "658d0f7a7768559ffd0849900f73ee76d4828aaa72b6b1dc73f545d28b874fd1",
      "copyEngine": true
    };
    var fs = require("fs");
...
app.listen({
  ...
  console.log(`\u{1F680}Server is running on port ${env.PORT}`);
});
